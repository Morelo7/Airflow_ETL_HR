CREATE OR REPLACE PROCEDURE STG.SP_SYNC_STG_TABLE_STRUCTURE(
    V_SCHEMA_CORE_NAME IN VARCHAR2,
    V_CORE_TABLE_NAME IN VARCHAR2,
    V_SCHEMA_STG_NAME IN VARCHAR2,
    V_STG_TABLE_NAME IN VARCHAR2)
AS
  CURSOR C1 IS
